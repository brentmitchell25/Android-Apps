...
public class TouchableAreaManager {
	...
	public TouchableAreaManager() {
		...
		graph.addNode(new BuildingMapAreaBox(0, 1645, 1132, 1923, 1306));
		graph.addNode(new BuildingMapAreaBox(1, 1631, 1556, 1935, 1761));
		graph.addNode(new BuildingMapAreaBox(2, 1708, 1322, 1791, 1438));
		graph.addNode(new BuildingMapAreaBox(3, 2697, 937, 2810, 1078));
		graph.addNode(new BuildingMapAreaBox(4, 2196, 1303, 2317, 1426));
		graph.addNode(new BuildingMapAreaBox(5, 2263, 1101, 2411, 1233));
		...
		// 1692));
		// graph.addNode(new BuildingMapAreaBox("daisy", 1163, 1303, 1427,
		// 2043));
