...
public class BuildingMapAreaBox extends TouchableAreaGraphNode {
	...
	public BuildingMapAreaBox(String building_name, float x_top, float y_top, float x_bot, float y_bot) {
	...
	public BuildingMapAreaBox(int building_index, float x_top, float y_top, float x_bot, float y_bot) {
		super(x_top, y_top, x_bot, y_bot);
	...
	public void onClick(View ms) {
		Intent intent = new Intent(ms.getContext(), Building.class);
...
// Later on when we don't need to demo this we should make the BuildingMapAreas polygons
