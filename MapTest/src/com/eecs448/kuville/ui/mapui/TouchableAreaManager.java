...
public class TouchableAreaManager {
	...
	public TouchableAreaManager() {
		...
		graph.addNode(new BuildingMapAreaBox("eaton", 1645, 1132, 1923, 1306));
		graph.addNode(new BuildingMapAreaBox("fieldhouse", 1631, 1556, 1935, 1761));
		graph.addNode(new BuildingMapAreaBox("strong", 2263, 1101, 2411, 1233));
		graph.addNode(new BuildingMapAreaBox("union", 2697, 937, 2810, 1078));
		graph.addNode(new BuildingMapAreaBox("memorial_stadium", 2352, 452, 2594, 751));
		graph.addNode(new BuildingMapAreaBox("robinson", 2061, 1548, 2214, 1692));
		graph.addNode(new BuildingMapAreaBox("daisy", 1163, 1303, 1427, 2043));
		graph.addNode(new BuildingMapAreaBox("fraiser", 2698, 1234, 2752, 1359));
		graph.addNode(new BuildingMapAreaBox("watson", 2564, 1329, 2680, 1414));
		graph.addNode(new BuildingMapAreaBox("nichols", 740, 1855, 848, 1945));
		graph.addNode(new BuildingMapAreaBox("malot", 2196, 1303, 2317, 1426));
