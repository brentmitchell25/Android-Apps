...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		displayTweet = (TextView) findViewById(R.id.message);
			...
			try {
				...
				try {
					...
					for (twitter4j.Status tweet : tweets) {
						String temp = "@" + tweet.getUser().getScreenName()
								+ " - " + tweet.getText() + "\n";
						message.append(temp + "\n");
						Log.i("MainActivity", "@"
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					txtUpdate.setText("");
					displayTweet.setText(message);
					displayTweet.setVisibility(View.VISIBLE);
				}
			});
		}
